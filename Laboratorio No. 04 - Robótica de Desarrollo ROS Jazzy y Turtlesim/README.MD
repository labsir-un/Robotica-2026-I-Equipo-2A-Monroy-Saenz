...
flowchart TD
    ...
    B --> C{Lectura tecla<br/>stdscr.getch()}

    C -->|↑ / ↓| D[Flecha ↑ / ↓<br/>move(lin, 0)]
    C -->|← / →| E[Flecha ← / →<br/>move(0, ang)]

    D --> F[Publica mensaje Twist<br/>/turtle1/cmd_vel]
    E --> F

    F --> G[Turtlesim mueve<br/>la tortuga]
```
